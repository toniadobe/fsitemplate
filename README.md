...
* Go to <https://github.com/adobe/aem-fsi-template/releases/latest> and download `aem-fsi-template-{version}.zip`
* Upload `aem-fsi-template-{version}.zip` in AEMaaCS's site creation wizard to create a new site from that template.

## Build locally

Alternatively you can build `aem-fsi-template-{version}.zip` locally.
...
1. The site template ZIP file is now located below the template root: `aem-fsi-template-{version}.zip`.
...
* Commit, build and release latest Site Theme related changes in [Site Theme E2E Repo](https://github.com/adobe/aem-fsi-template-theme-e2e).
